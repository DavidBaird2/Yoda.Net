...
namespace Yoda.Net.Networking.Packet.Info
{
    public class PacketId
    {
      ...
      public static int LIST_CONNECTION_OTHERS = 788;
      
      public static int LIST_CONNECTION_OTHERS_RESULT = 789;
      ...
      public static int ADD_FAVORITE = 24576;
      
      public static int ADD_FAVORITE_RESULT = 24577;
      
      public static int REMOVE_FAVORITE = 24578;
      
      public static int REMOVE_FAVORITE_RESULT = 24579;
      
      public static int LIST_FAVORITE = 24580;
      
      public static int LIST_FAVORITE_RESULT = 24581;
      
      public static int ADD_MUTE_FAVORITE = 24582;
      
      public static int ADD_MUTE_FAVORITE_RESULT = 24583;
      
      public static int REMOVE_MUTE_FAVORITE = 24584;
      
      public static int REMOVE_MUTE_FAVORITE_RESULT = 24585;
      
      public static int REMOVE_OTHER_FAVORITE = 24592;
      
      public static int REMOVE_OTHER_FAVORITE_RESULT = 24593;
      ...
      public static int GET_SPEND_CAMPAIGN_ADS = 1488;
      
      public static int GET_SPEND_CAMPAIGN_ADS_RESULT = 1489;
      
      public static int PUSH_SPEND_CAMPAIGN_PAYMENT_RESULT = 1490;
      ...
      public static int GET_SALE_SHOP_REMAIN_INFO = 1418;
      
      public static int GET_SALE_SHOP_REMAIN_INFO_RESULT = 1419;
      ...
      public static int GET_RENTAL_SHOP = 1504;
      
      public static int GET_RENTAL_SHOP_RESULT = 1505;
      
      public static int BUY_RENTAL_SHOP_ITEM = 1506;
      
      public static int BUY_RENTAL_SHOP_ITEM_RESULT = 1507;
      
      public static int GET_VIP_ANNOUNCE_EVENT = 1450;
      
      public static int GET_VIP_ANNOUNCE_EVENT_RESULT = 1451;
      
      public static int GET_VIP_NOTIFICATION = 1440;
      
      public static int GET_VIP_NOTIFICATION_RESULT = 1441;
      
      public static int GET_VIP_COUNT_INFO = 1442;
      
      public static int GET_VIP_COUNT_INFO_RESULT = 1443;
      
      public static int GET_VIP_SHOP = 1444;
      
      public static int GET_VIP_SHOP_RESULT = 1445;
      
      public static int BUY_VIP_SHOP_ITEM = 1446;
      
      public static int BUY_VIP_SHOP_ITEM_RESULT = 1447;
      
      public static int GET_VIP_SHOP_FURNITURE_DETAIL = 1448;
      
      public static int GET_VIP_SHOP_FURNITURE_DETAIL_RESULT = 1449;
      
      public static int GET_VIP_AREA_ERROR_INFO = 1472;
      
      public static int GET_VIP_AREA_ERROR_INFO_RESULT = 1473;
      ...
      public static int GET_ANNOUNCE_DOKAN_INFO = 4152;
      
      public static int GET_ANNOUNCE_DOKAN_INFO_RESULT = 4153;
      ...
      public static int GET_EVENT_POINT_EXCHANGE_STATUS = 17952;
      
      public static int GET_EVENT_POINT_EXCHANGE_STATUS_RESULT = 17953;
      
      public static int EXCHANGE_EVENT_POINT = 17954;
      
      public static int EXCHANGE_EVENT_POINT_RESULT = 17955;
      ...
      public static int GET_PIGGSHOP = 22534;
      
      public static int GET_PIGGSHOP_RESULT = 22535;
      
      public static int GET_PIGGSHOP_CATEGORY = 22536;
      
      public static int GET_PIGGSHOP_CATEGORY_RESULT = 22537;
      
      public static int GET_PIGGSHOP_GACHA_RESULT = 22538;
      
      public static int GET_PIGGSHOP_RECOMMEND_RESULT = 22539;
      
      public static int GET_PIGGSHOP_SERIES = 22540;
      
      public static int GET_PIGGSHOP_SERIES_RESULT = 22541;
      
      public static int GET_PIGG_SHOP_ITEM_RANKING = 1385;
      
      public static int GET_PIGG_SHOP_ITEM_RANKING_RESULT = 1386;
      ...
      public static int GET_DIARY_ACTIVITY_FEED = 22296;
      
      public static int GET_DIARY_ACTIVITY_FEED_RESULT = 22297;
      ...
      public static int SHARE_DIARY_PAGE = 22316;
      
      public static int SHARE_DIARY_PAGE_RESULT = 22317;
      
      public static int GET_DIARY_SHARE = 22318;
      
      public static int GET_DIARY_SHARE_RESULT = 22319;
      
      public static int GET_DIARY_ACTIVITY_SUMMARY = 22329;
      
      public static int GET_DIARY_ACTIVITY_SUMMARY_RESULT = 22330;
      
      public static int GET_DIARY_COMMENT = 22331;
      
      public static int GET_DIARY_COMMENT_RESULT = 22332;
      
      public static int GET_SIMPLE_USER_PROFILE = 22336;
      
      public static int GET_SIMPLE_USER_PROFILE_RESULT = 22337;
      
      public static int GET_FEED_TOP_POPULAR_FEED_CONTENTS = 22334;
      
      public static int GET_FEED_TOP_POPULAR_FEED_CONTENTS_RESULT = 22335;
      
      public static int UPDATE_READ_DIARY_NOTIFICATION_SUMMARY = 22340;
      
      public static int UPDATE_READ_DIARY_NOTIFICATION_SUMMARY_RESULT = 22341;
      
      public static int GET_FEED_TOP = 22320;
      
      public static int GET_FEED_TOP_RESULT = 22321;
      
      public static int GET_FEED_PAGE_INDEX_LIST = 22322;
      
      public static int GET_FEED_PAGE_INDEX_LIST_RESULT = 22323;
      
      public static int GET_FEED_PAGE_CONTENTS = 22324;
      
      public static int GET_FEED_PAGE_CONTENTS_RESILT = 22325;
      
      public static int GET_FEED_VIEW_AVATAR_DATA = 22326;
      
      public static int GET_FEED_VIEW_AVATAR_DATA_RESULT = 22327;
      
      public static int UNSET_NEW_MARK_TARGET_DIARY = 22338;
      
      public static int UNSET_NEW_MARK_TARGET_DIARY_RESULT = 22339;
      
      public static int LOG_READ_FEED_PAGE = 22342;
      
      public static int LIST_BLOCK_USER = 24832;
      
      public static int LIST_BLOCK_USER_RESULT = 24833;
      
      public static int REMOVE_BLOCK_USER = 24834;
      
      public static int REMOVE_BLOCK_USER_RESULT = 24835;
      
      public static int LIST_BAN_USER = 24836;
      
      public static int LIST_BAN_USER_RESULT = 24837;
      
      public static int ANALYSIS_LOG = 22784;
      
      public static int ANALYSIS_SHOP_RANKING_LOG = 1384;
      
      public static int GET_DOT_MONEY_POINT = 25088;
      
      public static int GET_DOT_MONEY_POINT_RESULT = 25089;
      
      public static int DOT_MONEY_POINT_EVENT_INFO_RESULT = 25091;
      
      public static int DOT_MONEY_AGP_NOTIFICATION_RESULT = 25090;
