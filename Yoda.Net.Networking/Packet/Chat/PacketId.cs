...
namespace Yoda.Net.Networking.Packet.Chat
{
    public class PacketId
    {
      ...
      public static int  GET_CHAT_SERVER_TIME = 48;
      
      public static int  GET_CHAT_SERVER_TIME_RESULT = 49;
      ...
      public static int  BAN_USER_RESULT = 1087;
      
      public static int  ADD_BLOCK_USER = 3585;
      
      public static int  ADD_BLOCK_USER_RESULT = 3586;
      ...
      public static int  DOT_MONEY_POINT_EVENT_CHAT_RESULT = 3584;
      ...
      public static int  START_FEED = 3840;
      
      public static int  START_FEED_RESULT = 3841;
      
      public static int  FINISH_FEED = 3842;
      
      public static int  FINISH_FEED_RESULT = 3843;
