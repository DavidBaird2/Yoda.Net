namespace Yoda.Net.Networking.Data.Common
{
    ...
    public class UserProfileData
    {
        ...
        public int myFavoriteCount { get; set; }

        public int receiveFavoriteCount { get; set; }

  
        public bool isAllowAddFavorite { get; set; }

        public bool allowOpenFavoriteList { get; set; }
